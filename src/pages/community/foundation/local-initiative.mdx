...
We're happy to support both new and existing GraphQL meets; here’s what you need
...
- The Local accepts **GraphQL TSC oversight**:
  - At least one
    ...
    will assign a TSC member and supply the relevant details on approval of your
    Local).
...
- **Local artwork** adhering to the GraphQL Brand Guidelines; including avatars,
  event banners, and slide templates. \*\*
